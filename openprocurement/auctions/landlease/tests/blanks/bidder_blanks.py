...
def patch_auction_bidder(self):
    ...
    self.assertEqual(response.json['errors'], [{u'description': [
                     u'value of bid should be greater than value of auction'], u'location': u'body', u'name': u'value'}])
...
def reactivate_invalidated_bids(self):
    ...
    response = self.app.get(
        '/auctions/{}/bids/{}?acc_token={}'.format(self.auction_id, bid1_id, bid1_token))
    self.assertEqual(response.json['data']["status"], "invalid")
    response = self.app.get(
        '/auctions/{}/bids/{}?acc_token={}'.format(self.auction_id, bid2_id, bid2_token))
    self.assertEqual(response.json['data']["status"], "invalid")
    ...
    response = self.app.patch_json(
        '/auctions/{}/bids/{}?acc_token={}'.format(
            self.auction_id, bid1_id, bid1_token), {
            'data': {
                "status": "active"}}, status=422)
    self.assertEqual(response.json['errors'], [{u'description': [
                     u'value of bid should be greater than value of auction'], u'location': u'body', u'name': u'value'}])
    response = self.app.patch_json(
        '/auctions/{}/bids/{}?acc_token={}'.format(
            self.auction_id, bid2_id, bid2_token), {
            'data': {
                "status": "active"}}, status=422)
    self.assertEqual(response.json['errors'], [{u'description': [
                     u'value of bid should be greater than value of auction'], u'location': u'body', u'name': u'value'}])
    ...
    response = self.app.patch_json('/auctions/{}/bids/{}?acc_token={}'.format(
        self.auction_id, bid1_id, bid1_token), {'data': {"status": "active"}})
    self.assertEqual(response.json['data']["status"], "active")

    response = self.app.patch_json('/auctions/{}/bids/{}?acc_token={}'.format(
        self.auction_id, bid2_id, bid2_token), {'data': {"status": "active"}})
    self.assertEqual(response.json['data']["status"], "active")
...
def create_auction_bidder_document_nopending(self):
    ...
    response = self.app.post(
        '/auctions/{}/bids/{}/documents?acc_token={}'.format(
            self.auction_id, bid_id, bid_token), upload_files=[
